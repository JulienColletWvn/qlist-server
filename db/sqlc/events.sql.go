...
func (q *Queries) CreateEventContent(ctx context.Context, arg CreateEventContentParams) (EventsContent, error) {
	row := q.db.QueryRowContext(ctx, createEventContent,
		arg.Type,
		arg.Content,
		arg.Lang,
		arg.EventsID,
...
func (q *Queries) CreateEventPhoto(ctx context.Context, arg CreateEventPhotoParams) (EventsPhoto, error) {
	row := q.db.QueryRowContext(ctx, createEventPhoto, arg.Url, arg.EventsID)
	var i EventsPhoto
	err := row.Scan(
		&i.ID,
		&i.CreatedAt,
...
func (q *Queries) GetAdministratorEvent(ctx context.Context, arg GetAdministratorEventParams) (Event, error) {
	row := q.db.QueryRowContext(ctx, getAdministratorEvent, arg.Column1, arg.EventsID)
	var i Event
	err := row.Scan(
		&i.ID,
		&i.CreatedAt,
...
func (q *Queries) GetAdministratorEvents(ctx context.Context, dollar_1 int32) ([]Event, error) {
	rows, err := q.db.QueryContext(ctx, getAdministratorEvents, dollar_1)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetEventContents(ctx context.Context, eventsID int32) ([]EventsContent, error) {
	rows, err := q.db.QueryContext(ctx, getEventContents, eventsID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetPublicEvent(ctx context.Context, id int32) (Event, error) {
	row := q.db.QueryRowContext(ctx, getPublicEvent, id)
	var i Event
	err := row.Scan(
		&i.ID,
		&i.CreatedAt,
...
func (q *Queries) GetPublicEvents(ctx context.Context) ([]Event, error) {
	rows, err := q.db.QueryContext(ctx, getPublicEvents)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
